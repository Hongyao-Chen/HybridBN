...
class Client(object):
    ...
    def update(self,dataset=None, net=None):
        self.dataset = dataset
        self.ldr_train = DataLoader(DatasetSplit(dataset, self.idxs), batch_size=self.args.local_batch, shuffle=True,drop_last=True)
